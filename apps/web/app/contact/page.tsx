            ...
            <div className="col-lg-8 mb-sm-30">
              ...
              {submitted ? (
                ...
                <form name="contactForm" id="contact_form" className="form-border" onSubmit={handleSubmit}>
                  ...
                  <div className="field-set mb-3">
                    <textarea name="message" id="message" className="form-control" rows={5} placeholder="Your Message" required></textarea>
                  </div>

                  <div className="spacer-half"></div>

                  <div id="submit">
                    <input type="submit" id="send_message" value="Submit Message" className="btn btn-main" />
                  </div>
                </form>
              )}
            </div>
            ...
            <div className="col-lg-4">
              <div className="padding40 bg-color text-light box-rounded">
                ...
                <address className="s1">
                  <span>
                    <i className="fa fa-map-marker fa-lg mr-2"></i> Abiona Street By House of Favour, Main Gate, Obafemi Owode LGA, Redemption City, Ogun State
                  </span>
                  <br />
                  <span>
                  ...
                  <span>
                    ...
                    <a href="mailto:dareadeboyeinnovationhub@gmail.com" className="text-white">
