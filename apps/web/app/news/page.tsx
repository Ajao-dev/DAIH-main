          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <h1>News &amp; Articles</h1>
                <p>Insights, updates, and productivity tips from the DAIH community.</p>
              </div>
                ...
                <div className="bloglist item h-100 bg-white border rounded overflow-hidden">
                  <div className="post-content p-3">
                    <div className="post-image mb-3">
                      <img alt={art.title} src={art.img} className="img-fluid rounded" />
                    </div>
                    <div className="post-text">
                      <span className="badge bg-secondary mb-2">{art.tagline}</span>
                      ...
                      <Link className="btn-main btn-sm mt-2" href="/news-single">
                        Read more
                      </Link>
                    </div>
                  </div>
