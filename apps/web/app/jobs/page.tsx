          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <h1>Jobs</h1>
                <p>Join the team building innovation, community, and productivity at DAIH.</p>
              </div>
            ...
            <div className="col-md-10 offset-md-1">
              ...
              <div className="apply-note bg-color-secondary text-light p-4 rounded mb-4">
                ...
                <p className="mb-0">
                  ...
                  . Use the job title as your email subject. You can also reach us via the{' '}
                  <Link className="text-light" style={{ textDecoration: 'underline' }} href="/contact">
                    Contact page
                  </Link>
                  .
                </p>
              ...
              <div className="expand-list">
                {jobs.map((job, idx) => {
                  ...
                  return (
                    <div key={idx} className="expand-custom mb-4 border rounded p-4 bg-white">
                      <div
                      ...
                      >
                        <div>
                          ...
                          <div className="job-meta text-muted small">
                            <span className="mr-3"><i className="fa fa-map-marker mr-1"></i> {job.location}</span>
                            <span className="mr-3 ml-2"><i className="fa fa-clock-o mr-1"></i> {job.type}</span>
                            <span className="ml-2"><i className="fa fa-briefcase mr-1"></i> {job.dept}</span>
                          </div>
                          ...
                          <div className="row">
                              ...
                              <div className="box-custom">
                                ...
                                <ul className="list-unstyled">
                                  {job.requirements.map((r, i) => (
                                    <li key={i} className="mb-1"><i className="fa fa-check text-success mr-2"></i> {r}</li>
                                  ))}
                                </ul>
                              </div>
                            </div>
                            ...
                            <div className="col-md-6 mb-3">
                              <div className="box-custom">
                                ...
                                <ul className="list-unstyled">
                                  {job.offer.map((o, i) => (
                                    <li key={i} className="mb-1"><i className="fa fa-check text-success mr-2"></i> {o}</li>
                                  ))}
                                </ul>
                              </div>
                            </div>
