        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden sm:inline-flex items-center justify-center px-4 py-2 text-xs font-semibold text-white bg-[#d56c04] hover:bg-[#ab4a07] rounded-lg shadow-sm transition-all duration-200"
            >
              Customer Portal
            </a>
            <Link
              href="/plans"
              className="inline-flex items-center justify-center px-4 py-2 text-xs font-semibold text-slate-900 bg-amber-400 hover:bg-amber-300 rounded-lg shadow-sm transition-all duration-200"
            >
              Book Space
            </Link>
          </div>
