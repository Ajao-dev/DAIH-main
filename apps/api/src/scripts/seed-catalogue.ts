...
export const SEED_CATALOGUE_DATA: SeedResource[] = [
  {
    ...
    description: 'Flexible workstation in our dynamic open coworking lounge with 24/7 power, high-speed WiFi, and water.',
    capacity: 50,
  ...
  },
  {
    ...
    description: 'Assigned personal workstation with personal desk drawer and daily access in a quiet, productive workspace zone.',
    capacity: 24,
  ...
  },
  {
    ...
    description: 'Air-conditioned private workspace with presentation screen/TV suitable for teams of professionals.',
    capacity: 8,
  ...
  },
  {
    ...
    description: 'Professional meeting & workshop space equipped with presentation screen, air-conditioning, and flexible room setups.',
    capacity: 40,
  ...
  },
  {
    ...
    description: 'Scenic outdoor premium rooftop ambience perfect for photoshoots, content creation, social events, and corporate networking.',
    capacity: 100,
  ...
  },
  {
    ...
    description: 'Professional content creation and podcast recording space with studio lighting and production support.',
    capacity: 10,
