...
export const ResetPasswordCard: React.FC = () => {
  ...
  const getStrengthMeta = () => {
    ...
    if (strength === 2) return { text: 'Fair', color: 'bg-amber-500', count: 2 };
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Your password has been successfully reset. Existing sessions have been securely revoked.
              </p>
            </div>
          ...
          <>
            ...
            <form noValidate onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-slate-700" htmlFor="newPassword">
                  New Password
                </label>
                      ...
                      {[1, 2, 3, 4].map((step) => (
                        <div
                          ...
                          className={`flex-1 rounded-full transition-all duration-300 ${
                            step <= strengthMeta.count ? strengthMeta.color : 'bg-slate-200'
                          }`}
                        />
                      ))}
                    </div>
              ...
              <ul className="space-y-1.5 pt-1 text-xs text-slate-500 font-medium">
                <li
                  className={`flex items-center gap-2 transition-colors ${
                    hasMinLength ? 'text-emerald-600 font-bold' : 'text-slate-500'
                  }`}
                >
                  <Check
                ...
                <li
                  className={`flex items-center gap-2 transition-colors ${
                    hasNumberOrSymbol ? 'text-emerald-600 font-bold' : 'text-slate-500'
                  }`}
                >
                  <Check
                    className={`w-3.5 h-3.5 ${
